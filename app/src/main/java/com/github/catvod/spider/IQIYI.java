...
public class IQIYI extends Spider {
    ...
    public String detailContent(List<String> list) {
        ...
        String str2 = "https://pcw-api.iqiyi.com";
        try {
            ...
            JSONArray optJSONArray2 = optJSONObject2.optJSONArray("director");package com.github.catvod.spider;
...
public class IQIYI extends Spider {
    ...
    protected JSONArray V7;
    protected JSONObject c = new JSONObject();
    protected HashMap<String, String> PL = new HashMap<>();
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        ...
        try {
            ...
            String gR = mI.gR(str3, iqiyi.V7(str3));
            JSONObject jSONObject = new JSONObject();
            try {
                JSONArray optJSONArray = new JSONObject(gR).optJSONObject("data").optJSONArray("list");
                JSONArray jSONArray = new JSONArray();
                int i = 0;
                while (i < optJSONArray.length()) {
                    JSONObject optJSONObject = optJSONArray.optJSONObject(i);
                    String optString = optJSONObject.optString("name");
                    String c = iqiyi.c(str3, optJSONObject.optString("imageUrl"));
                    String optString2 = optJSONObject.optString("score");
                    String optString3 = optJSONObject.optString("playUrl");
                    if (!optJSONObject.optString("albumId").equals("")) {
                        optString3 = optJSONObject.optInt("sourceId") != 0 ? "/video/video/baseinfo/" + optJSONObject.optString("tvId") + "?userInfo=verify&jsonpCbName=videoInfo39" : "/albums/album/avlistinfo?aid=" + optJSONObject.optString("albumId") + "&size=200";
                    } else if (optJSONObject.optLong("tvId") != 0) {
                        optString3 = "/video/video/baseinfo/" + optJSONObject.optString("tvId") + "?userInfo=verify&jsonpCbName=videoInfo39";
                    }
                    JSONObject jSONObject2 = new JSONObject();
    ...
    public String detailContent(List<String> list) {
        ...
        String str2 = "https://pcw-api.iqiyi.com";
        try {
            String str3 = str2 + list2.get(0) + "&page=1";
            JSONObject jSONObject = new JSONObject(mI.gR(str3, V7(str3))).getJSONObject("data");
            JSONObject jSONObject2 = new JSONObject();
            int optInt = jSONObject.optInt("page");
            System.out.println("page-----------------" + optInt);
            JSONObject optJSONObject = jSONObject.optJSONArray("epsodelist") != null ? jSONObject.optJSONArray("epsodelist").optJSONObject(0) : jSONObject;
            jSONObject2.put("vod_id", list2.get(0));
            jSONObject2.put("vod_name", optJSONObject.optString("name").replaceAll("第\\d+(?:集|期)", ""));
            jSONObject2.put("vod_pic", c(str3, optJSONObject.optString("imageUrl")));
            JSONObject optJSONObject2 = optJSONObject.optJSONObject("people");
            JSONArray optJSONArray = optJSONObject2.optJSONArray("main_charactor");
            if (optJSONArray == null) {
                optJSONArray = optJSONObject2.optJSONArray("producer");
            ...
            if (optInt > 1) {
                int i4 = 0;
                while (i4 < optInt - 1) {
                    String str4 = str2 + list2.get(0) + "&page=" + (i4 + 2);
                    int i5 = 0;
                    for (JSONArray optJSONArray4 = new JSONObject(mI.gR(str4, V7(str4))).getJSONObject("data").optJSONArray("epsodelist"); i5 < optJSONArray4.length(); optJSONArray4 = optJSONArray4) {
    ...
    public String homeContent(boolean z) {
        ...
        try {
            ...
            String gR = mI.gR(str, iqiyi.V7(str));
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("class", iqiyi.V7);
            if (z) {
                jSONObject.put("filters", iqiyi.I);
            }
            try {
                JSONArray optJSONArray = new JSONObject(gR).optJSONObject("data").optJSONArray("list");
                JSONArray jSONArray = new JSONArray();
                ...
                while (i < optJSONArray.length()) {
                    JSONObject optJSONObject = optJSONArray.optJSONObject(i);
                    String optString = optJSONObject.optString("name");
                    String c = iqiyi.c(str, optJSONObject.optString("imageUrl"));
                    String optString2 = optJSONObject.optString("score");
                    String optString3 = optJSONObject.optString("playUrl");
                    if (!optJSONObject.optString("albumId").equals("")) {
                        if (optJSONObject.optInt("sourceId") != 0) {
    ...
    public String homeVideoContent() {
        try {
            JSONArray jSONArray = new JSONObject(mI.gR("https://pcw-api.iqiyi.com/api.php/app/index_video?token=", V7("https://pcw-api.iqiyi.com/api.php/app/index_video?token="))).getJSONArray("list");
    ...
    public String searchContent(String str, boolean z) {
        try {
            ...
            JSONArray optJSONArray = new JSONObject(mI.gR(str2, V7(str2))).optJSONObject("data").optJSONArray("docinfos");
            JSONArray jSONArray = new JSONArray();
            for (int i = 0; i < optJSONArray.length(); i++) {
                JSONObject optJSONObject = optJSONArray.getJSONObject(i).optJSONObject("albumDocInfo");
                JSONObject jSONObject = new JSONObject();
                optJSONObject.optString("albumLink");
                jSONObject.put("vod_id", "/albums/album/avlistinfo?aid=" + optJSONObject.optString("qipu_id") + "&size=200&page=1");
