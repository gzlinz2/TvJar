...
public class Kunyu77 extends Spider {
    ...
    private HashMap<String, String> sgetHeaders(String url) {
            ...
            while (keys.hasNext()) {
                ...
                try {
                    if (extendsAll == null) {
                        ...
                        String filterContent = OkHttpUtil.string(filterUrl, sgetHeaders(filterUrl));
    ...
    public String detailContent(List<String> ids) {
        try {
            ...
            content = OkHttpUtil.string(url, sgetHeaders(url));
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) {
        try {
            ...
            try {
                ...
                content = OkHttpUtil.string(jxUrl, sgetHeaders(jxUrl));
