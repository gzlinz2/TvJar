...
public class Cokemv extends Spider {
    ...
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObject("{\"ddzy\":{\"sh\":\"藍光采集(暂时)\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokebb\":{\"sh\":\"極速路線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"tkm3u8\":{\"sh\":\"采集路线\",\"pu\":\"\",\"sn\":0,\"or\":999},\"777_\":{\"sh\":\"十三號線路\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokemv001\":{\"sh\":\"海外線路\",\"pu\":\"\",\"sn\":0,\"or\":999},\"mp4\":{\"sh\":\"藍光路线\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokemv\":{\"sh\":\"高速路線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"if101\":{\"sh\":\"海外(禁國內)\",\"pu\":\"\",\"sn\":0,\"or\":999}}");
    ...
    public String detailContent(List<String> ids) {
        try {
            ...
            remark = doc.select("div.module-info-content").get(4).text();
            List<String> actors = new ArrayList<>();
            Elements aa = doc.select("div.module-info-content").get(2).select("a");
            for (int j = 0; j < aa.size(); j++) {
                actors.add(aa.get(j).text());
            }
            actor = TextUtils.join(",", actors);
            List<String> directors = new ArrayList<>();
            Elements bb = doc.select("div.module-info-content").get(0).select("a");
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (sourceName.contains(key)) {
                    ...
                    if (matcher.find()) {
                        ...
                        String remark = link.select("div.module-info-content").get(4).text();
