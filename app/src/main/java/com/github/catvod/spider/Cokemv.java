...
public class Cokemv extends Spider {
    ...
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObjec("{\"ddzy\":{\"sh\":\"藍光采集(暂时)\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokebb\":{\"sh\":\"極速路線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"tkm3u8\":{\"sh\":\"采集路线\",\"pu\":\"\",\"sn\":0,\"or\":999},\"777_\":{\"sh\":\"十三號線路\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokemv001\":{\"sh\":\"海外線路\",\"pu\":\"\",\"sn\":0,\"or\":999},\"mp4\":{\"sh\":\"藍光路线\",\"pu\":\"\",\"sn\":0,\"or\":999},\"cokemv\":{\"sh\":\"高速路線\",\"pu\":\"\",\"sn\":0,\"or\":999},\"if101\":{\"sh\":\"海外(禁國內)\",\"pu\":\"\",\"sn\":0,\"or\":999}}");
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) {
        try {
            ...
            // 获取分类数据的url
            String url = siteUrl + "/vodshow/" + TextUtils.join("-", strArr) + ".html";
