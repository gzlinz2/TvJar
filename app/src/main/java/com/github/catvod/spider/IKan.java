...
public class IKan extends AppYsV2 {
    ...
    private void S(final String str, final String str2) {
        ...
        try {
            ...
            hashMap2.put("Host", "cms.ikan6.vip");
            hashMap2.put("User-Agent", "okhttp/3.11.0");
            OkHttpUtil.post(this.y, "http://cms.ikan6.vip/api.php/gctvapi.auth/register", hashMap, hashMap2, new OKCallBack.OKCallBackString() {
                @Override
    ...
    public void login(String str, String str2) {
        ...
        try {
            ...
            hashMap2.put("Host", "cms.ikan6.vip");
            hashMap2.put("User-Agent", "okhttp/3.11.0");
            OkHttpUtil.post(y, "http://cms.ikan6.vip/api.php/gctvapi.auth/login", headers, hashMap2, new OKCallBack.OKCallBackString() {
                @Override
                public void onFailure(Call call, Exception exc) {
                }
    ...
    public String homeVideoContent() {
        try {
            String url = "http://cms.ikan6.vip/api.php/gctvapi.vod";
    ...
    public void init(Context context, String str) {
        super.init(context, "http://cms.ikan6.vip/api.php/gctvapi.vod");
    }
