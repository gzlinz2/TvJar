...
public class Lib extends Spider {
    private static final String siteUrl = "https://libvio.fun/";  //网站url
    private static final String siteHost = "libvio.fun";          //网站host
    ...
    private Pattern regexCategory = Pattern.compile("/type/(\\d+).html");                  //分类页
    private Pattern regexVid = Pattern.compile("/detail/(\\d+).html");                     //详情页
    ...
    protected static HashMap<String, String> Headers() {
        ...
        headers.put("User-Agent", "Mozilla/5.0 (Linux; Android 10; HarmonyOS; BKL-AL20; HMSCore 6.5.1.302; GMSCore 22.24.13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/12.1.1.301 Mobile Safari/537.36");
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) {
        try {
            ...
            headers.put("origin", " https://libvio.fun/");
            headers.put("User-Agent", " Mozilla/5.0 (Linux; Android 10; HarmonyOS; BKL-AL20; HMSCore 6.5.1.302; GMSCore 22.24.13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/12.1.1.301 Mobile Safari/537.36");
            headers.put("Accept", " */*");
            headers.put("Accept-Language", " zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7");
            headers.put("Accept-Encoding", " gzip, deflate");
            headers.put("referer", " https://libvio.fun/");
            // 播放页 url
                ...
                if (scContent.startsWith("var player_")) { // 取直链
                    ...
                    if (playerConfig.has(player.getString("from"))) {
                        ...
                        if (player.getString("from").contains("LINE")) {
                            ...
                            result.put("playUrl", "");
                            result.put("url", url);
                            //   result.put("header", "{\"Referer\", \"https://libvio.fun/\"}");
                            return result.toString();
                        }
                        break;
                    }
